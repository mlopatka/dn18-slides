...
%My name is Martin Lopatka, I do...
%I'm here to talk to you about the Biggest data I know of... The Web.
%The world’s largest shared public resource... The Web.
% So, we; Mozilla, work a bit on the web, we build a web browser, you may have heard of it.. it's called firefox. And, so as part of that, it is fairly important for use to know a thing or two about the World wide web.
